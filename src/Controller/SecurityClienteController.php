...
{
    #[Route(path: '/c/login', name: 'app_login_client')]
    ...
    #[Route(path: '/c/login_check', name: 'app_login_client_check')]
    public function logincheck(Security $security, AuthenticationUtils $authenticationUtils, Request $request, UserClienteRepository $userClienteRepository): Response
    {
        ...
        if ($userbd) {
            ...
            $token = new UsernamePasswordToken($user, 'cliente', ['app_user_client_provider'], $user->getRoles());
    ...
    #[Route(path: '/c/logout', name: 'app_logout_client')]
